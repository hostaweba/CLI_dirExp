...
class DirUtils:
    ...
    def display_directories(parent_dir, level_name):
        """Display the list of directories under a given level with file counts and sizes."""
        ...
        for index, directory in enumerate(directories):
            ...
            file_count = DirUtils.count_files(dir_path)
            dir_size = DirUtils.get_directory_size(dir_path)
            table.add_row(str(index + 1), directory, str(file_count), f"{dir_size:.2f}")
